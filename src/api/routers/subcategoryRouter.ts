...
router.get(
	...
	Validator.validateIds([
		{ paramName: "id", model: Subcategory, type: Constant.Subcategory },
	]),
	subcategoryController.getAllProductBySubcategory
);
...
router.post(
	"/",
	validateToken(),
	Validator.validateFields({ required: ["name", "categoryId"] }),
	Validator.validateIds([
		{ paramName: "categoryId", model: Category, type: Constant.Category },
	]),
